...
class RawReviewManagerTests(TestCase):
    ...
    def test_set_owner_and_sitter_fks(self):
        ...
        owner_raw_review_data = RawReview.objects.values_list('owner_object__id', flat=True)
        ...
        sitter_raw_review_data = RawReview.objects.values_list('sitter_object__id', flat=True)
